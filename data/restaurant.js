...
const RESTAURANT_DATA = {
  ...
  ui: {
    ...
    strings: {
      ...
      am: {
        ...
        navMenu: "menu", navAbout: "ስለ እኛ", navVisit: "አድራሻ",
        estLine: "ከ{year} ጀምሮ · {city}",
        heroCtaMenu: "menu'ን ይመልከቱ",
        ...
        noResultsTitle: "ያላቹት ምግብ አልተገኘም",
  ...
  items: [
    ...
    },
    {
      ...
      name: "እንቁላል ፍርፍር", nameEn: "Eggs · Enkulal",
     price:300,
